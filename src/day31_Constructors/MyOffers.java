...
public class MyOffers {
    ...
    public static void main(String[] args) {
       Offer offer1 =new Offer();// declaring the object 1
        offer1.setInfo("VA","Amazon Inc", "SDET", 110000, true,
                true,true,true);

        Offer offer2 = new Offer();// Object2
        offer2.setInfo("CA", "Sony", "QA", 120000, true,true,
                true, true);
        ...
        Offer [] myOffers= {offer1, offer2, offer3, offer4,offer5};// stroe the offers into an array

        // Add the array into ArrayList fullTimeOffers.
       ...
       fullTimeOffers.removeIf(p -> !p.isFullTime); //removes if the offer is not fulltime
        ...
        localOffers.removeIf(p-> !(p.location.equals("VA") || p.location.equals("CA")));// removes the offer that is not from lovcal area
